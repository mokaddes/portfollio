  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav text-uppercase ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link js-scroll-trigger" href="#professional"><i class="fa fa-fw fa-code"></i> Professional <span class="sr-only">Skills</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link js-scroll-trigger" href="#projects"><i class="fa fa-fw fa-project-diagram"></i> Projects</a>
        </li>
        <li class="nav-item">
          <a class="nav-link js-scroll-trigger" href="#frameworks"><i class="fa fa-fw fa-briefcase"></i> Frameworks</a>
        </li>
        <li class="nav-item">
          <a class="nav-link js-scroll-trigger" href="#tools"><i class="fa fa-fw fa-wrench"></i> Tools</a>
        </li>
        <li class="nav-item">
          <a class="nav-link js-scroll-trigger" href="#personal"><i class="fa fa-fw fa-user"></i> Personal <span class="sr-only">Skills</span></a>
        </li>
      </ul>
    </div>
  </div>
          ...
          <div class="col-6 col-sm-4 col-md-3 col-lg-2">
            <div class="card-body">
              <a href="https://www.rawmarket.cz" title="RAWmarket.cz" target="_blank" rel="nofollow">
                <img class="img-fluid d-block mx-auto img-desaturated" src="/assets/img/projects/rawmarket.png" alt="RAWmarket.cz">
              </a>
            </div>
          </div>
    </div>
